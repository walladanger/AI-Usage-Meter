...
export function UsageSettingsPage() {
  ...
  return <section className="feature-page" aria-labelledby="settings-page-title">
    <header className="feature-page__hero"><span className="feature-page__eyebrow">Preferences</span><h1 id="settings-page-title">Settings</h1><p>Choose refresh, notifications, tray behavior, retention, and appearance. API keys are held in the Windows Credential Manager.</p></header>
