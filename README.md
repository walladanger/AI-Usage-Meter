...
Local-first Windows 11 utility for tracking personal AI subscription allowances and reset times across ChatGPT/Codex, Claude/Claude Code, and Gemini. It is built from the Ember Studio Foundation with React, TypeScript, Vite, and Tauri.
